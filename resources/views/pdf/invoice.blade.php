...
<body>
    <div class="container">
                ...
                <div class="info-number">
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="text-align: right;">{{ \Carbon\Carbon::parse($data['invoice_date'])->format('d-m-Y') }}</td>
                        </tr>
                        <tr>
        ...
        <div style="margin-top: 10px;" class="info">
            <div><strong>Please make payment to the following account :</strong></div>
            <br>
            <table>
                <tr>
                    <td class="label">Bank Name</td>
                    <td style="width: 15px; text-align: center;">:</td>
                    <td class="amount">{{ $data['company_bank']['bank']['name'] }}</td>
                </tr>
                <tr>
                    <td class="label">Bank Account Number</td>
                    <td style="width: 15px; text-align: center;">:</td>
                    <td class="amount"><strong>{{ $data['company_bank']['account_number'] }}</strong></td>
                </tr>
                <tr>
                    <td class="label">Bank Account Name</td>
                    <td style="width: 15px; text-align: center;">:</td>
                    <td class="amount">{{ $data['company_bank']['holder_name'] }}</td>
                </tr>
            </table>
        </div>
